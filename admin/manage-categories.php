                              ...
                              <tbody>
                                 ...
                                 <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                       ...
                                       <a href="manage-categories.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</button>
                                    </td>
                                 </tr>
                                 <?php $cnt=$cnt+1;}} ?>                                      
                              </tbody>

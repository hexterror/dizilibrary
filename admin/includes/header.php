        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand">
                    <img src="assets/img/LMS-DP_logo.png" />
                </a>
            </div>
                            ...
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Students <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="signup_inside.php">Reg New Student</a></li>
                                    </ul>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Admin Panel <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
